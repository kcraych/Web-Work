                ...
                c => new
                    {
                        ...
                        driveHrsFromHome = c.Single(nullable: false),
                        activityType = c.Int(nullable: false),
                        activityOtherDesc = c.String(),
                        activityName = c.String(),
                        activityNotes = c.String(),
                        activityWinter = c.Boolean(nullable: false),
                        activitySpring = c.Boolean(nullable: false),
                        activitySummer = c.Boolean(nullable: false),
                        activityFall = c.Boolean(nullable: false),
                        activitySiteName = c.String(),
                        activitySiteURL = c.String(),
                    })
